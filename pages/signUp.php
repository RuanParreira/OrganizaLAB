    ...
    <main>
        ...
        <form action="../includes/signUp.php" method="post" class="form">
            ...
            <div class="inputForm">
                ...
                <input type="text" name="usuario" id="usuario" class="input" placeholder="Digite seu usuario" required>
            </div>
            ...
            <div class="inputForm">
                ...
                <input type="text" name="email" id="emal" class="input" placeholder="Digite seu e-mail" required>
            </div>
